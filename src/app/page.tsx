...
import { Leaf, ShieldCheck, Home, Heart, Star, ArrowRight } from "lucide-react";
...
export default function HomePage() {
  const featuredMenu = menuItems.filter((m) => m.badge === "best_seller").slice(0, 4);
      ...
      <section className="section-padding bg-cream">
        <div className="container-content">
          <SectionHeading
            ...
            title="Keunggulan Senja Kitchen"
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            <div>
              ...
              <h2 className="font-heading text-3xl font-semibold tracking-tight text-primary md:text-4xl">
                Dimulai dari Cinta pada Rasa Lokal
              </h2>
              <p className="mt-4 leading-relaxed text-charcoal/75">
                Senja Kitchen lahir dari keinginan menghadirkan hidangan lokal
                dengan sentuhan modern. Setiap pagi kami memilih bahan segar,
                memasak dengan penuh perhatian, dan menyajikan dalam suasana
                yang hangat dan minimalis.
              </p>
              <p className="mt-3 leading-relaxed text-charcoal/75">
                Kami percaya pengalaman makan yang baik bukan hanya tentang
                rasa, tapi juga tentang ruang, pelayanan, dan momen yang
                tercipta.
              </p>
      ...
      <section className="section-padding bg-soft/40">
        <div className="container-content">
          <SectionHeading
            ...
            description="Ulasan jujur dari mereka yang sudah merasakan Senja Kitchen."
          />
      ...
      <section className="section-padding bg-cream">
        <div className="container-content">
          <SectionHeading
            ...
            description="Tips, resep, dan cerita di balik dapur Senja Kitchen."
          />
          <div className="grid gap-6 md:grid-cols-3">
            {articles.map((a) => (
              <Link
      ...
      <section className="section-padding bg-soft/40">
        <div className="container-content">
          <SectionHeading
            ...
            description="Dua lokasi strategis di Jakarta, siap menyambut Anda."
          />
